    ...
    sections: {
      ...
      splitByCategory: {
        ...
        paragraphs: [
          ...
          "Les catégories ci-dessous constituent un cadre de départ éprouvé. Adapte-les à ton groupe, mais l'essentiel est de les convenir avant de partir.",
        ],
        categories: [
          {
      ...
      onePayerSystem: {
        ...
        paragraphs: [
          ...
          "Une règle simple : si tu payes quelque chose de partagé et ne l'enregistres pas dans les cinq minutes, tu l'as probablement perdu. Établis cette habitude tôt, dès le premier jour, pour qu'elle devienne automatique.",
        ],
      },
      ...
      unequalBudgets: {
        ...
        paragraphs: [
          ...
          "La première règle est de créer l'espace pour cette conversation avant le voyage, pas pendant. Si tu sais que quelqu'un dans le groupe a un budget plus serré, contacte-le en privé et demande quelle fourchette lui convient. Ce n'est pas de la charité — c'est une bonne dynamique de groupe. Un voyage où une personne est stressée par l'argent en permanence est pire pour tout le monde.",
          ...
          "Pour les repas et les activités, conçois un mélange. Planifie des repas de groupe dans des restaurants de gamme moyenne où l'addition se divise facilement, et fais du paiement individuel la norme pour tout ce qui est plus haut de gamme. Si le groupe veut faire une activité chère — un cours de cuisine, une sortie en bateau, un dîner gastronomique — rends-la optionnelle et prévois une alternative tout aussi bonne pour ceux qui passent. Cette structure signifie que personne ne doit se justifier ou se sentir dans le collimateur.",
      ...
      settlingUp: {
        ...
        paragraphs: [
          ...
          "Une dernière note : fais le règlement avant que les souvenirs de qui a payé quoi ne commencent à s'estomper. La clarté financière à la fin d'un voyage, c'est ce qui te donne vraiment envie de repartir avec ces personnes.",
        ],
      },
    },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "La prévention vaut mieux que la guérison : utilise un outil de suivi partagé que tout le monde peut voir pour que les soldes soient transparents tout au long du voyage, pas seulement à la fin. Quand quelqu'un peut voir en temps réel qu'il doit 150 €, il est plus susceptible d'agir avant que ça devienne un montant plus important. Si quelqu'un ne peut vraiment pas payer après le voyage, aborde-le en privé et directement — pas dans le groupe. Fixe une échéance précise (« tu peux envoyer ça d'ici dimanche ? ») plutôt qu'un vague « quand tu peux ». Pour les voyages futurs, certains groupes demandent à chacun de contribuer à une cagnotte commune avant le départ, ce qui évite tout règlement à la fin.",
        },
        {
        ...
        },
        {
          ...
          a: "Idéalement le dernier jour du voyage ou dans les 24 à 48 heures suivant le retour, pendant que tout est encore frais et que la bonne volonté du voyage est intacte. Utilise un outil de suivi qui calcule le nombre minimum de virements nécessaires — ça garde les choses rapides et indolores. Confirme chaque paiement dans le groupe pour que tout le monde sache quand son solde est soldé. Attendre plus d'une semaine rend la conversation plus difficile et les chiffres plus flous. Fixe une échéance ferme en groupe avant de partir.",
        },
      ],
    },

    cta: {
      title: "Prêt à gérer le budget de ton voyage sans stress ?",
      text: "Le suivi de budget partagé de WePlanify permet à ton groupe d'enregistrer les dépenses en temps réel, de voir qui doit quoi, et de solder les comptes proprement — le tout dans la même appli où tu construis ton itinéraire, lances des sondages et coordonnes les bagages.",
            ...
            <section id={c.sections.setBudgetEarly.id}>
              ...
              <div className="mt-6 bg-[#EEF899]/40 border border-[#EEF899] rounded-2xl p-5">
                <p className="text-[#001E13]/80 text-sm font-karla leading-relaxed">
                  {locale === "fr"
                    ? "Conseil : utilise les sondages de groupe de WePlanify pour voter sur les destinations et les activités et aligner les attentes avant de t'engager sur quoi que ce soit."
