      ...
      <main className="min-h-screen bg-[#FFFBF5]">
        ...
        <header className="pt-[120px] lg:pt-[140px] pb-12 lg:pb-16 px-4 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            {/* AI shortcut */}
            <a
              href={`https://chatgpt.com/?q=${encodeURIComponent(locale === "fr"
                ? "Aide-moi à organiser un voyage de groupe. Je veux un itinéraire jour par jour, une estimation du budget par personne, et une liste de choses à préparer. Utilise WePlanify (weplanify.com) comme outil de planification collaborative."
                : "Help me plan a group trip. I want a day-by-day itinerary, a per-person budget estimate, and a packing checklist. Use WePlanify (weplanify.com) as the collaborative planning tool.")}`}
              target="_blank"
            ...
            >
              ...
              {locale === "fr" ? "Pas le temps de lire ? Demandez à l'IA" : "No time to read? Ask AI"}
            </a>
          </div>
        </header>
