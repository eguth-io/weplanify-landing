...
export default async function SchoolTripPage({ params }: Props) {
  ...
  const faqItems = isEn
    ...
    : [
        ...
        { q: "Comment collecter autorisations parentales et régimes alimentaires sans paperasse ?", a: "Arrêtez de courir après les formulaires papier. Utilisez un voyage partagé avec une liste de participants — chaque parent confirme la présence, les restrictions alimentaires et les contacts d'urgence au même endroit. WePlanify garde le compte à jour pour que vous sachiez qui a validé et qui pas." },
        ...
        { q: "Comment répartir les rôles entre accompagnateurs ?", a: "Assignez chaque accompagnateur à un sous-groupe d'élèves dans le voyage. Chacun voit sur son téléphone l'effectif de son groupe, les régimes et les contacts d'urgence. Utilisez les sondages pour trancher les arbitrages d'activité — fini le 'on n'a jamais décidé qui va au musée'." },
            ...
            <div className="max-w-[900px] mx-auto space-y-8">
              ...
              <p className="text-[#FFFBF5]/65 text-lg lg:text-[22px] font-karla leading-[1.8]">
                {isEn
                  ...
                  : "Pour les allergies sévères ou conditions médicales, attachez la documentation directement au participant. Les accompagnateurs peuvent y accéder hors ligne si leur téléphone a du réseau — et le personnel sur place (hôtel, restaurant, guide de musée) peut voir l'info pertinente immédiatement. Ce geste tout simple a évité plus d'un passage aux urgences en milieu de séjour."}
              </p>
            </div>
          </section>
        </FadeIn>
