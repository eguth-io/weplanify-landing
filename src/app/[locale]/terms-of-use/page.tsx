...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const currentUrl = `${SITE_URL}/${locale}/terms-of-use`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...Object.fromEntries(
          routing.locales.map((l) => [l, `${SITE_URL}/${l}/terms-of-use`])
        ),
        "x-default": `${SITE_URL}/en/terms-of-use`,
      },
    },
  };
}
            ...
            <div className="space-y-8">
              {sections.map((section, i) => (
                <div key={i}>
                  ...
                  <p className="font-karla text-[#001E13]/75 text-base leading-relaxed whitespace-pre-line">
                    {section.body}
                  </p>
                  {section.list && (
