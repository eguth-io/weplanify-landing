        ...
        <footer className="mt-[120px] md:mt-[180px] lg:mt-[230px] mx-4 md:mx-8 lg:mx-[60px] border-t border-b border-[#E5E5E5] py-6 md:py-8 lg:py-6">
          ...
          <div className="hidden lg:flex gap-[100px] justify-between">
            ...
            <div className="flex gap-3 mt-3">
              ...
              {/* <Link href={'https://www.linkedin.com/company/weplanify'} target="_blank" aria-label="Suivez WePlanify sur LinkedIn">
                <div className="w-[30px] h-[30px] bg-orange rounded-[6px] flex items-center justify-center cursor-pointer hover:bg-[#e53415] transition-colors">
                  <Image
                    src="/linkedin.svg"
                    alt="Icône LinkedIn - Suivez WePlanify"
                    width={24}
                    height={24}
                    className="brightness-0 invert"
                  />
          ...
          <div className="lg:hidden">
            ...
            <div className="flex flex-col items-start mb-8 md:mb-10">
              ...
              <div className="flex gap-3">
                ...
                <Link href={'https://www.tiktok.com/@weplanify'} target="_blank" aria-label="Suivez WePlanify sur TikTok">
                  <div className="w-[28px] h-[28px] md:w-[30px] md:h-[30px] bg-orange rounded-xl flex items-center justify-center cursor-pointer hover:bg-[#e53415] transition-colors">
                    <Image
                      src="/tiktok.svg"
                      alt="Icône TikTok - Suivez WePlanify"
                      width={20}
