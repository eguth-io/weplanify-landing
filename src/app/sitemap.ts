...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  try {
    ...
    const useCasePages = ["trip-with-friends", "bachelorette-trip", "alternatives", "alternatives/wanderlog", "alternatives/squadtrip", "alternatives/tripit", "alternatives/cruzmi", "alternatives/best-group-trip-planner-apps"];
    for (const locale of locales) {
