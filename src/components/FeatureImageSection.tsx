...
const BUBBLES: Bubble[] = [
  ...
  { id: "polls", icon: Vote, side: "left", top: 10, edge: 38 },
  { id: "expenses", icon: Wallet, side: "left", top: 32, edge: 37 },
  { id: "invite", icon: Users, side: "left", top: 54, edge: 33, dim: true },
  { id: "trip", icon: Map, side: "left", top: 76, edge: 31 },
  // Right column
  { id: "activities", icon: Search, side: "right", top: 9, edge: 32 },
  ...
  { id: "transport", icon: Bus, side: "right", top: 78, edge: 34 },
];
